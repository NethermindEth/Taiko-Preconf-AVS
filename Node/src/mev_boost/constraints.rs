...
mod tests {
    ...
    fn test_constraints_message_digest() {
        ...
        assert_eq!(
            message.digest().unwrap(),
            [
                9, 87, 0, 71, 187, 129, 0, 133, 126, 114, 244, 187, 129, 105, 194, 105, 195, 115,
                27, 220, 144, 157, 88, 34, 184, 108, 130, 34, 84, 248, 88, 125
            ]
        );
    }
    ...
    fn test_signed_constraints_compute_domain_custom() {
        ...
        assert_eq!(
            domain,
            [
                109, 109, 111, 67, 11, 65, 190, 76, 219, 52, 209, 131, 221, 220, 165, 57, 131, 55,
                98, 109, 205, 207, 175, 23, 32, 193, 32, 45, 59, 149, 248, 78
            ]
        );
    }
    ...
    fn test_signed_constraints_compute_signing_root_custom() {
        let digest = [
            9, 87, 0, 71, 187, 129, 0, 133, 126, 114, 244, 187, 129, 105, 194, 105, 195, 115, 27,
            220, 144, 157, 88, 34, 184, 108, 130, 34, 84, 248, 88, 125,
        ];
        let domain = [
            109, 109, 111, 67, 11, 65, 190, 76, 219, 52, 209, 131, 221, 220, 165, 57, 131, 55, 98,
            109, 205, 207, 175, 23, 32, 193, 32, 45, 59, 149, 248, 78,
        ];

        let signing_root =
            SignedConstraints::compute_signing_root_custom(digest.tree_hash_root().0, domain);

        assert_eq!(
            signing_root,
            [
                46, 115, 119, 45, 23, 162, 89, 198, 203, 58, 165, 97, 28, 21, 0, 117, 149, 27, 106,
                219, 120, 115, 115, 227, 114, 157, 221, 247, 183, 14, 65, 54
            ]
        );
    }
}
