...
contract LookaheadPosting is LookaheadFixtures {
    ...
    function test_forcePushLookahead_setsNonEmptyLookaheadInNextEpoch_Case2() external {
        ...
        vm.assertEq(lookaheadBuffer[2].preconfer, addr_3);
        vm.assertEq(lookaheadBuffer[2].timestamp, slot20Timestamp);
        vm.assertEq(lookaheadBuffer[2].prevTimestamp, nextEpochStart);
    ...
    function test_forcePushLookahead_setsNonEmptyLookaheadInNextEpoch_Case3() external {
        ...
        vm.assertEq(lookaheadBuffer[2].preconfer, addr_2);
        vm.assertEq(lookaheadBuffer[2].timestamp, slot14Timestamp);
        vm.assertEq(lookaheadBuffer[2].prevTimestamp, nextEpochStart);
        vm.assertEq(lookaheadBuffer[2].isFallback, false);

        vm.assertEq(lookaheadBuffer[3].preconfer, addr_5);
        vm.assertEq(lookaheadBuffer[3].timestamp, slot31Timestamp);
        vm.assertEq(lookaheadBuffer[3].prevTimestamp, slot14Timestamp);
